...
# ═══ Path Resolution ═══
# main.py está em backend/
# Os módulos estão em backend/shared/python e backend/components/*/python
_CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))         # backend/
_DEV_BASE = _CURRENT_DIR                                         # backend/
